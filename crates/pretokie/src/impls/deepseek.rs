...
impl<'a> Iterator for DeepSeek<'a> {
    type Item = &'a str;
    ...
    fn next(&mut self) -> Option<&'a str> {
        ...
        if is_ascii_letter(b) {
            ...
            if clen > 0 {
                ...
                // ASCII punct prefix for letters (apostrophe is ASCII)
...
mod tests {
    ...
    #[test]
    fn digits_chunked() { assert_eq!(split("12345"), vec!["123", "45"]); }
    ...
    fn marks_with_letters() {
        // Thai: กัน (letter + mark + letter) stays together
